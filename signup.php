...
<div class="container">
    ...
    <div class="form">
        <form id="contactform" method="POST">
            ...
            <p class="contact"><label for="gender"> BIO</label></p>
            <input type="text" placeholder="BIO(required)" name="gender" required="">

            </select><br><br>

            <p class="contact"><label for="role">Address</label></p>
            <input type="text" placeholder="Address (required)" name="role" required="">

            <br><br>

            <p class="contact"><label for="course">Education</label></p>
            <input type="text" placeholder="Education(required)" name="course" required="">
